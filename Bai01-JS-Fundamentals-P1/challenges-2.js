...
const markHigherBMI1 = (markBMI1 > johnBMI1 ? `Mark's BMI ${markBMI1} is higher than John's BMI ${johnBMI1}` : `John's BMI ${johnBMI1} is higher than Mark's BMI${markBMI1}`)
...
const markHigherBMI2 = (markBMI2 > johnBMI2 ? `Mark's BMI ${markBMI2} is higher than John's BMI ${johnBMI2}` : `John's BMI ${johnBMI2} is higher than Mark's BMI${markBMI2}`)
